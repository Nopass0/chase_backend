...
export default (app: Elysia) =>
  app
    ...
    .get('/enums/status',           () => Object.values(Status),          {
      tags: ['admin'], headers: authHeader,
      response: { 200: t.Array(t.Enum(Status)), 401: ErrorSchema, 403: ErrorSchema }
    })
    .get('/enums/transaction-type', () => Object.values(TransactionType), {
      tags: ['admin'], headers: authHeader,
      response: { 200: t.Array(t.Enum(TransactionType)), 401: ErrorSchema, 403: ErrorSchema }
    })
    .get('/enums/method-type',      () => Object.values(MethodType),      {
      tags: ['admin'], headers: authHeader,
      response: { 200: t.Array(t.Enum(MethodType)), 401: ErrorSchema, 403: ErrorSchema }
    })
    .get('/enums/currency',         () => Object.values(Currency),        {
      tags: ['admin'], headers: authHeader,
      response: { 200: t.Array(t.Enum(Currency)), 401: ErrorSchema, 403: ErrorSchema }
    })
    .get('/enums/rate-source',      () => Object.values(RateSource),      {
      tags: ['admin'], headers: authHeader,
      response: { 200: t.Array(t.Enum(RateSource)), 401: ErrorSchema, 403: ErrorSchema }
    })
    .get('/enums/all', () => ({
    ...
    .post('/ban-user',
      async ({ body, error }) => {
        try {
          await db.user.update({ where: { id: body.id }, data: { banned: true } });
          return { ok: true };
        } catch (e) {
      ...
      },
      {
        ...
        response: { 200: t.Object({ ok: t.Boolean() }), 404: ErrorSchema, 401: ErrorSchema, 403: ErrorSchema }
      }
    )
        ...
        try {
          ...
          const user = await db.user.create({
            ...
            select: {
              ...
              balanceUsdt: true, balanceRub: true, createdAt: true
            }
          });
          ...
          if (e instanceof Prisma.PrismaClientKnownRequestError && e.code === 'P2002')
            return error(409, { error: 'Пользователь с таким email уже существует' });
          throw e;
        }
      },
      {
        ...
        response: {
          201: t.Object({
            ...
            balanceUsdt: t.Number(), balanceRub: t.Number(),
            createdAt: t.String(), plainPassword: t.String(),
            wallet: t.Object({
              id: t.String(),
              address: t.String(),
              isActive: t.Boolean(),
          ...
          409: ErrorSchema, 401: ErrorSchema, 403: ErrorSchema
        }
      }
    )
    ...
    .post('/regenerate-password',
      async ({ body, error }) => {
        try {
          const plain = randomBytes(8).toString('hex');
          const hash  = await sha256(plain);
          await db.user.update({ where: { id: body.id }, data: { password: hash } });
      ...
      },
      {
        ...
        response: {
          ...
          404: ErrorSchema, 401: ErrorSchema, 403: ErrorSchema
        }
      }
    )
    ...
    .put('/update-user',
        ...
        try {
          const u = await db.user.update({
            ...
            data: {
              ...
              balanceUsdt: body.balanceUsdt, balanceRub: body.balanceRub,
              banned: body.banned
            },
            select: {
              id: true, email: true, name: true,
              balanceUsdt: true, balanceRub: true,
      ...
      },
      {
        ...
        body: t.Object({
          ...
          name: t.String(), balanceUsdt: t.Number(),
          balanceRub: t.Number(), banned: t.Boolean()
        }),
        response: {
          200: t.Object({
            id: t.String(), email: t.String(), name: t.String(),
            balanceUsdt: t.Number(), balanceRub: t.Number(),
            banned: t.Boolean(), createdAt: t.String()
          }),
          404: ErrorSchema, 401: ErrorSchema, 403: ErrorSchema
        }
      }
        ...
        try {
          const u = await db.user.findUniqueOrThrow({
            ...
            select: {
              ...
              banned: true, createdAt: true,
              sessions: {
                select: { id: true, ip: true, createdAt: true, expiredAt: true }
              }
            }
          });
          return {
        ...
        response: {
          200: t.Object({
            ...
            sessions: t.Array(t.Object({
              id: t.String(), ip: t.String(),
              createdAt: t.String(), expiredAt: t.String()
            }))
          }),
          404: ErrorSchema, 401: ErrorSchema, 403: ErrorSchema
        }
    ...
    .post('/create-admin',
      ...
      {
        tags: ['superadmin'], headers: authHeader,
        response: {
          201: t.Object({ id: t.String(), token: t.String(), createdAt: t.String() }),
          409: ErrorSchema, 401: ErrorSchema, 403: ErrorSchema
        }
      }
    )
